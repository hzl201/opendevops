...
- `[LKJT_PersonLocationCenter].[dbo].[PL_SetDatabase]`
- ![](/fog3zAKsWFkGmhj.jpg)
- 人员定位中心库ip修改。
- `[LKJT_MonitorCenter].[dbo].[AutomationDataBase]`
- ![](/fjc58vA9G3aqxUI.jpg)
- 监测中心库三维ip修改。
- `[LKJT_MonitorCenter].[dbo].[DataBaseConfig]`
- `[LKJT_MonitorCenter].[dbo].[MineRealTimeTransforStatus]`
- ![](/JRFaqK4NzI1hHlm.jpg)
- ![](/zUIQenZ3Oih6YPF.jpg)
- 安全监测中心库ip修改。
- `[LKJT_MonitorCenter].[dbo].[HydrologicalDataBase]`
- `[LKJT_MonitorCenter].[dbo].[HydrologicalTransforStatus]`
- ![](/yd2imQfatUMGRDl.jpg)
- ![](/8e3lqnRCXxAHSPZ.jpg)
- 水文监测中心库ip修改。
- `[LKJT_MonitorCenter].[dbo].[ImpactPressureDataBase]`
- ![](/s9n4mUkaDNXoi1r.jpg)
- 应力和微震ip修改。
- 最后进行数据备份的设置。
